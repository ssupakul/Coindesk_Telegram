    ...
    for coin in COINS:
        ...
        if current_price > ema_200:
            ...
            if in_fibo_zone or in_4h_fibo_zone or in_ob_zone or in_fvg_zone:
                ...
                if ob_info["has_bullish_ob"] and not signal_type and rsi < RSI_OVERBOUGHT: signal_type = f"Smart Money OB Reversal 🚀{vol_tag}"
        ...
        elif rsi >= RSI_OVERBOUGHT or is_bear_divergence or (ob_info.get("has_bearish_ob") and ob_info.get("bearish_ob_price") is not None):
